...
export const SITE_TITLE = "Flight School in Reno, NV | NV Flight Training";
...
export const SITE_SHORT_DESCRIPTION =
  "NV Flight offers premier pilot training in Nevada, specializing in self-paced and accelerated flight training programs for student pilots and advanced aviators. From discovery flights and private pilot licenses to instrument ratings and commercial certifications, our experienced instructors, modern aircraft, and proven training methods help you achieve your aviation goals quickly and safely. Serving Reno, Sparks, and the surrounding areas, we provide aircraft rentals, headset sales, and personalized instruction designed to fit your schedule and budget. Start your aviation journey today with Reno’s trusted flight school.";
...
export const COMPANY_NAME = "NV Flight School";
...
export const INSTAGRAM_URL = "https://www.instagram.com/nvflight/";
