export const GeneralFAQs = [
  ...
  },
  {
    ...
    content: `No prior experience is required! Our programs welcome everyone, from absolute beginners to experienced pilots seeking advanced ratings or refresher training. Check out our <a href="/programs/private-pilot-asel" class="text-primary-600 font-semibold hover:underline hover:brightness-125 duration-200">Private Pilot program</a> for new aviators.`,
  },
  {
    title: "Why is mountain flying training important in Reno?",
    content: `The Reno/Tahoe area is surrounded by mountains. Flying here comes with unique challenges like high-altitude takeoffs, rapidly changing weather, and terrain navigation. Our dedicated <a href="/programs/mountain-flight-training" class="text-primary-600 font-semibold hover:underline hover:brightness-125 duration-200">Mountain Flying Training</a> program prepares you to handle these conditions safely.`,
  },
  {
