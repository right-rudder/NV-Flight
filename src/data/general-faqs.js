export const GeneralFAQs = [
  ...
  },
  {
    ...
    content: `On average, students can earn their Private Pilot Certificate in 4–6 months with consistent lessons. Your timeline may vary based on your availability, lesson frequency, and weather. <a href="/programs/private-pilot-asel" class="text-accent-500 hover:underline hover:brightness-125 duration-200">See program details</a>.`,
  },
  {
    title: "Can I visit the school or schedule a Discovery Flight before enrolling?",
    content: `Yes! We encourage you to visit our Reno location, meet our instructors, and book a Discovery Flight to experience what flying is all about. <a href="/contact" class="text-accent-500 hover:underline hover:brightness-125 duration-200">Contact us to schedule your visit</a>.`,
  },
  {
    title: "Do you offer advanced ratings or career-track training?",
    content: `Absolutely! We offer Instrument, Commercial, and Certified Flight Instructor (CFI) programs, as well as recurrent and mountain flying training. Whether you’re aiming for a career in aviation or just want to keep learning, we’ve got you covered. <a href="/programs" class="text-accent-500 hover:underline hover:brightness-125 duration-200">Explore all programs</a>.`,
  },
];
