const aproxPilotTrainingCosts = {
  data: {
    ...
    pageKeywords:
      "Approximate Pilot Training Costs, Pilot Training Process, Reno Flight School, Phoenix Flight School, Scottsdale Flight School, Chandler Flight School, Gilbert Flight School, Apache Junction Flight School, Tempe Flight School, Queen Creek Flight School, Fountain Hills Flight School, Paradise Valley Flight School, Phoenix Flight Training, Reno Flight Training, Scottsdale Flight Training, Chandler Flight Training, Gilbert Flight Training, Apache Junction Flight Training, Tempe Flight Training, Queen Creek Flight Training, Fountain Hills Flight Training, Paradise Valley Flight Training",

    //top header
    header: {
      stars: true,
      imagePath: "/src/assets/NVFlight-flight-school-happy-pilots-2.jpg",
      imageAlt:
...
export default aproxPilotTrainingCosts;
