  ...
  data: {
    ...
    contentSplit: {
      ...
      finalSection: {
        ...
        descriptions: [
          "Becoming a flight instructor does not have a minimum time, but you do need a commercial pilot license along with an instrument rating. To qualify for a commercial pilot license, a pilot must accumulate a minimum of 250 flight hours. That being said, if the minimum requirements are met it can take a little over a week to complete training if you are studying full time (accelerated). If studying part time when able (flexible), it can take from a few weeks to a few months to be prepared for the CFI checkride and receive your endorsement.",
          "We now offer a 30 day CFI/CFII program which is our recommended route to getting your CFI certificates. In this program, you will be working alongside pilots at a similar stage in their careers that are also working on their CFI certificates. Click the button below to get more information and start the enrollment process.",
        ],
      },
      finalButton: {
        name: "30 Day CFI Program",
