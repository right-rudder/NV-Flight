  ...
  data: {
    ...
    contentSplit: {
      ...
      descriptions: [
        ...
        "Start your training today at NVFlight and take the first step towards building seniority within the airlines, unlocking a world of exciting possibilities and experiences that await you in the aviation industry.",
      ],
      finalButton: {
        name: "Enroll Now",
        link: "/enroll-at-NVFlight",
      ...
      imageAlt:
        "NVFlight Flight School airline pilot next to a commercial airplane",
    },
    ...
    contentCTA: {
      ...
      descriptions: [
        ...
        "The aviation industry upholds an unwavering commitment to safety, and this commitment seamlessly extends to flight training at NVFlight.",
        ...
        "NVFlight takes safety seriously. We are a team of highly trained professionals. In addition, our aircraft are meticulously maintained and inspected regularly.",
      ],
      imagePath: "/src/assets/preflight.webp",
      imageAlt:
        "NVFlight Flight School student and instructor doing a preflight check on a Cessna 172",
    },
  },
};
