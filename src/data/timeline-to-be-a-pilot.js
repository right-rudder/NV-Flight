const timelineToBePilot = {
  data: {
    //SEO Header Stuff
    pageTitle: "Timeline to be a Pilot | NV Flight Flight School, Reno, NV",
    pageDescription:
      "Curious about the timeline to become a pilot? NV Flight offers a detailed timeline of the pilot training process.  Get a clear understanding of the steps involved in your pilot journey. We're in the Phoenix, Arizona area at Falcon Field.  Many of our students come from Reno, Gilbert, Scottsdale, Apache Junction, Chandler, Tempe, Queen Creek, Fountain Hills, Paradise Valley, Phoenix",
    pageKeywords:
      "Timeline to Become a Pilot, Pilot Training Process, Reno Flight School, Phoenix Flight School, Scottsdale Flight School, Chandler Flight School, Gilbert Flight School, Apache Junction Flight School, Tempe Flight School, Queen Creek Flight School, Fountain Hills Flight School, Paradise Valley Flight School, Phoenix Flight Training, Reno Flight Training, Scottsdale Flight Training, Chandler Flight Training, Gilbert Flight Training, Apache Junction Flight Training, Tempe Flight Training, Queen Creek Flight Training, Fountain Hills Flight Training, Paradise Valley Flight Training",

    //top header
    header: {
      stars: true,
      imagePath: "/src/assets/airplane-streaking-by-a-runway-in-Reno-az.webp",
      imageAlt:
    ...
    contentSplit: {
      ...
      descriptions: [
        ...
        "Start your training today at NV Flight and take the first step towards building seniority within the airlines, unlocking a world of exciting possibilities and experiences that await you in the aviation industry.",
      ],
      finalButton: {
        name: "Enroll Now",
        link: "/enroll",
      ...
      imageAlt:
        "NV Flight Flight School airline pilot next to a commercial airplane",
    },

    contentCTA: {
      upperHeading: "Safety First",
      heading: "Is Flight Training Safe?",
      descriptions: [
        ...
        "The aviation industry upholds an unwavering commitment to safety, and this commitment seamlessly extends to flight training at NV Flight.",
        ...
        "NV Flight takes safety seriously. We are a team of highly trained professionals. In addition, our aircraft are meticulously maintained and inspected regularly.",
      ],
      imagePath: "/src/assets/preflight.webp",
      imageAlt:
        "NV Flight Flight School student and instructor doing a preflight check on a Cessna 172",
    },
  },
};

export default timelineToBePilot;
