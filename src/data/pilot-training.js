const pilotTraining = {
  data: {
    //SEO Header Stuff
    pageTitle: "Pilot Training | NV Flight Flight School, Reno, NV",
    pageDescription:
      "Learn to fly at NV Flight Flight School in Reno, NV. We offer a variety of pilot training programs to help you achieve your aviation goals. Contact us today to learn more!",
    pageKeywords:
      "Pilot Training, Flight School, Flight Training, Pilot Training, Learn to Fly, Private Pilot, Sport Pilot, Recreational Pilot, Flight Instructor, Flight Instruction, Flight School Reno, NV, Kankakee Flight School, Kankakee Flight Training, Reno Pilot Training, Reno Learn to Fly, Reno Private Pilot, Reno Sport Pilot, Reno Recreational Pilot, Reno Flight Instructor, Reno Flight Instruction",

    //top header
    header: {
      stars: true,
      imagePath:
        "/src/assets/NV Flight-flight-school-Reno-az-cfe-and-student-after-successful-checkride.jpg",
      imageAlt:
        "NV Flight Flight School airplane landing at Falcon Field Airport in Reno, Arizona",
      headerH1: `Pilot Training<br>Programs`,
      paragraph:
        "NV Flight makes becoming a pilot simple. Offering pathways to the airlines, we will take you from square one to being a commercial pilot. Our programs are designed to be efficient and easy to understand.",
      buttons: [
        {
          name: "Enroll Now",
          link: "/enroll",
